...
| `frontend-design` | 未确认公开仓库；可从自己的技能目录安装 | `~/.agents/skills/frontend-design/` | 本机可用 Skill，用于高质量前端页面生成 |
| `design-taste-frontend` | 未确认公开仓库；可从自己的技能目录安装 | `~/.agents/skills/design-taste-frontend/` | 本机可用 Skill，用于反 AI 味和审美校准 |
| `frontend-css-patterns` | 未确认公开仓库；可从自己的技能目录安装 | `~/.agents/skills/frontend-css-patterns/` | 本机可用 Skill，用于 CSS 视觉模式 |
| `tailwind-design-system` | 未确认公开仓库；可从自己的技能目录安装 | `~/.agents/skills/tailwind-design-system/` | 本机可用 Skill，用于 token 和组件系统 |
| `shadcn-layouts` | 未确认公开仓库；可从自己的技能目录安装 | `~/.agents/skills/shadcn-layouts/` | 本机可用 Skill，用于 shadcn/Tailwind 布局稳定性 |
...
| `claude-page-review` | 未确认公开仓库；可从自己的技能目录安装 | `~/.codex/skills/claude-page-review/` | 本机自定义/本机可用 Skill，用于 Claude 二次页面审查 |
| `remote-codex-worker` | 未确认公开仓库；可从自己的技能目录安装 | `~/.codex/skills/remote-codex-worker/` | 本机自定义 Skill，用于把 Offer-Compass 任务交给 agent-remote |
